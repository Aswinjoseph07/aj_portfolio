...
function Home() {
  return (
    <div className="bg-dark text-white  w-100 position-relative">
      ...
      <div className="name1" style={{position:"absolute",top:"22%" ,left:"15%"}}>
        <h3>I'm</h3>
       ...
       <button className="bt btn btn-outline-success" 
        style={{position:"absolute",top:"50%" ,left:"18%"}}><i className="bi bi-download"></i>RESUME</button></a>
      </div>
    </div>
  );
}
